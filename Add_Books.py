...
class Add(Tk):
    def __init__(self):
        ...
        self.title('Add Book')
        self.canvas = Canvas(width=500, height=500, bg='brown')
        self.canvas.pack()
        a = StringVar()
        b = StringVar()
        c = StringVar()
        ...
        Label(self, text='Book Details:',bg='light blue',fg='black',font=('Courier new', 20, 'bold')).place(x=100, y=70)
        Label(self, text='').pack()
        Label(self, text='Book Name:',bg='light blue',fg='black', font=('Courier new', 10, 'bold')).place(x=60, y=180)
        Entry(self, textvariable=b, width=30).place(x=170, y=182)
        Label(self, text='Book Author:',bg='light blue',fg='black', font=('Courier new', 10, 'bold')).place(x=60, y=230)
        Entry(self, textvariable=c, width=30).place(x=170, y=232)
        Button(self, text="Submit",bg="green", command=b_q).place(x=190, y=300)
Add().mainloop()